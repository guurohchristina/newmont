...
const slidesData = [
      { img: "images/newmont4.png", label: "bvknskvkdzvgbchj\vnsk\ kbkbfvbkk bkdfbjqknoi buiehfkliwes hiwbfugf khiheidhih hbiwhsuyguifh", link: "https://newmontmining.sharepoint.com/SitePages/Global-Objective-Maps.aspx" },
      { img: "images/raman.png", label: "knvius\bj jvbvbuy\hj\ jvbis\fbyugdgb jhigbiy", link: "page2.html" },
      { img: "images/raman2.png", label: "Cafeteriajb nkbjgvjbu jhjbsdvuygwj jhgwhiuhf", link: "page3.html" },
      { img: "images/raman3.png", label: "Cafeteria jbbfihviwkbf bvifojgokw chifuqhih", link: "page3.html" },
      { img: "images/newmont2.png", label: "Cafeteria kifivhihf jbibfugihuif bkfbihkgeqw", link: "page3.html" },
      { img: "images/newmont4.png", label: "Cafeteria iudhwkviuhfq h\ihfivyhf8o9 biwefojgoq higiegjoueorgh", link: "page3.html" },
    ];
